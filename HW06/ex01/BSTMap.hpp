...
/*
 * REJECT SOCIETY (HUMANITY (JAVA)), RETURN TO C++
 *
 * you can see all the most C++ish things possible in this last homework!
 * i studied and searched them up especially for you!
 * good luck reading documentations!
 * you can consider this as my generous Christmas present!
 * 
 * EMBRACE UNIQUE POINTERS!!!!!!!
 */
